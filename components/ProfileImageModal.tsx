...
const ProfileImageModal: React.FC<ProfileImageModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-black w-full max-w-lg flex flex-col rounded-lg shadow-2xl border border-transparent dark:border-gray-800"
      ...
      >
        ...
        <footer className="flex justify-end gap-4 p-4 bg-gray-50 dark:bg-gray-950 rounded-b-lg border-t dark:border-gray-700">
