...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-black w-full max-w-4xl max-h-[90vh] flex flex-col rounded-lg shadow-2xl border border-transparent dark:border-gray-800"
        onClick={e => e.stopPropagation()}
      >
        <header className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 rounded-t-lg">
